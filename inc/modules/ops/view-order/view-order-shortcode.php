 ...
 * - Exposes drivers/assign/unassign endpoints via data-* for the dropdown actions.
 * ==========================================================
 */
...
function knx_ops_view_order_shortcode() {
    ...
    <div id="knxOpsViewOrderApp"
         ...
         data-drivers-url="<?php echo esc_attr($drivers_url); ?>"
         data-assign-driver-url="<?php echo esc_attr($assign_driver_url); ?>"
         data-unassign-driver-url="<?php echo esc_attr($unassign_driver_url); ?>"
